...
<?php foreach($get_grpposts as $get_grppost){?>
<div class="col-5 status" >
<table>
<tr><td><a href ="<?php echo base_url();?>home/profile/<?php echo $userid =  $get_grppost->idnumber." " ;?>">
<figure class="dp" 
    style="background-image: url('<?php echo base_url();?>images/user<?php echo $get_grppost->idnumber;?>_.jpg')">
  </figure></td><td>
<h3>&nbsp;&nbsp;&nbsp;<a href ="<?php echo base_url();?>home/profile/<?php echo $userid =  $get_grppost->idnumber." " ;?>">
<?php echo $get_grppost->fname." ";?><?php echo $get_grppost->mname." ";?><?php echo $get_grppost->lname." ";?></h3></a>
<h5>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $get_grppost->post_date." ";?></h5>
</td></tr></table>
<br><h4>
<?php echo $get_grppost->text." ";?></h4>
<hr style="margin-bottom: 5px;border-top: #000 1px solid;">
<div class="container">
<a data-toggle="collapse" data-parent="#accordion" data-target="#comment<?php echo $get_grppost->grpstat_id;?>"><i class="fa fa-comments-o" style="font-size:15px;color:red;cursor: pointer;"> Comments</i></a>
</div>
<div id="comment<?php echo $get_grppost->grpstat_id;?>" class="panel-collapse collapse">
...
<font color="black"><?php foreach($names as $name){?>
    ...
    <input type="hidden" name="member_id" value="<?php echo $idmember->member_id." ";?>"><?php }?>
    <input type="hidden" name="grpstat_id" value="<?php echo $get_grppost->grpstat_id;?>">
    ...
    <input type="text" id="comments<?php echo $get_grppost->grpstat_id;?>" name="grp_comment" placeholder="Write a comment" style="width: 250px">
    <a data-toggle="collapse" data-parent="#accordion" href="#smiley<?php echo $get_grppost->grpstat_id;?>">
    ...
    <div id="smiley<?php echo $get_grppost->grpstat_id;?>" class="collapse" style="float: right;padding-top: 5px;">
      <?php echo $smiley_tables; ?></div>
      </form>
    <hr style="margin-bottom: 10px;margin-top: 10px;">

    <?php foreach($comments as $comment){?>
        <?php $a = $get_grppost->grpstat_id; $b = $comment->grpstat_id; if($a==$b) { ?>
    <table width="430px">
    ...
    <?php $a = $get_grppost->grpstat_id; $b = $comment->grpstat_id; if($a==$b) { echo $comment->fname." ";?><?php echo $comment->lname." ";}?></strong></font>
    <?php $a = $get_grppost->grpstat_id; $b = $comment->grpstat_id; if($a==$b) { echo $comment->grp_comment." ";}?>
        <h6 style="float: right;margin: 0px;margin-right: 12px; font-size: 13px;">
    <?php $a = $get_grppost->grpstat_id; $b = $comment->grpstat_id; if($a==$b) { echo $comment->grpcomment_date." ";?>| <?php echo $comment->grpcomment_time." ";}?></h6> </td></tr></table> 
