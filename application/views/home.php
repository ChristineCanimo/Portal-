      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
              ...
              <ul class="dropdown-menu notify-drop">
                ...
                <div class="drop-content">
                  ...
                  <li>
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-9 pd-l0"><a href="profile/<?php echo $userid =  $notifdetail->idnumber." " ;?>"><?php echo $notifdetail->fname." ";?><?php echo $notifdetail->lname." ";?></a> commented on this<a href="<?php echo base_url();?>index.php/home/post_commented/<?php echo $notifdetail->stat_id." ";?>" style="color: red;text-transform: lowercase;"> post</a>
                  ...
                  <li>
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-9 pd-l0"><a href="profile/<?php echo $userid =  $notifdetail->idnumber." " ; ?>"><?php echo $notifdetail->fname." ";?><?php echo $notifdetail->lname." ";?></a>Added you to a group <a href="<?php echo base_url();?>index.php/home/group/<?php echo $grp_id =  $notifdetail->group_id." " ;?>" style="color: red;text-transform: lowercase;">
                  ...
                  <?php if($notifdetail->type=='grpcomment') { ?>
                  ...
                  <li>
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-9 pd-l0"><a href="profile/<?php echo $userid =  $notifdetail->idnumber." " ;?>"><?php echo $notifdetail->fname." ";?><?php echo $notifdetail->lname." ";?></a>Posted on the group <?php foreach($getgrpcomments as $getgrpcomment){?><a href="<?php echo base_url();?>index.php/home/notifgroup/<?php echo $grp_id =  $getgrpcomment->group_id." " ;?>" style="color: red;text-transform: lowercase;"><?php $a = $notifdetail->grpstat_id; $b = $getgrpcomment->grpstat_id; if($a==$b) { echo $getgrpcomment->group_name." ";?>.<?php } ?></a><?php } ?>
                      <a href="" class=""><i class="fa fa-settings"></i></a>
                      <hr>
                      <p class="time"><?php $time = new DateTime($notifdetail->datetime);
                      $date = $time->format('n.j.Y');
                  ...
                  <li>
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-9 pd-l0"><a href="profile/<?php echo $userid =  $notifgrpdetail->idnumber." " ;?>"><?php echo $notifgrpdetail->fname." ";?><?php echo $notifgrpdetail->lname." ";?></a>Posted on the group <?php foreach($get_grpposts as $get_grppost){?><a href="<?php echo base_url();?>index.php/home/notifgroup/<?php echo $grp_id =  $get_grppost->group_id." " ;?>" style="color: red;text-transform: lowercase;"><?php echo $get_grppost->group_name." ";?>.</a><?php } ?>
                      <a href="" class=""><i class="fa fa-settings"></i></a>
                      <hr>
                  ...
                  <li>
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-9 pd-l0"><a href="profile/<?php echo $userid =  $notifdetail->idnumber." " ;?>"><?php echo $notifdetail->fname." ";?><?php echo $notifdetail->lname." ";?></a>Posted on your <?php foreach($getposts as $getpost){?><a href="<?php echo base_url();?>index.php/home/profile/<?php echo $userid =  $getpost->to_whom." " ;?>" style="color: red;text-transform: lowercase;">wall.</a><?php } ?>
                      <a href="" class=""><i class="fa fa-settings"></i></a>
                      <hr>
                      <p class="time"><?php $time = new DateTime($notifdetail->datetime);
                      $date = $time->format('n.j.Y');
            ...
            <li class="active"><a href="home"><i class="fa fa-home"> HOME</i></a></li>
    ...
    <div class="col-2 gilid">
      <ul><?php foreach($details as $detail){?>
        ...
        <li><a href="tryit_418.htm#home"><table><tr><td style="padding-right: 5px;">
          ...
          </figure></td><td><?php echo $detail->fname." ";?><?php echo $detail->mname." ";?><?php echo $detail->lname." ";?></td></tr></table></a>
        </li><br>
        <li><a href="home"><span class="glyphicon glyphicon-th-list"></span> News Feed</a></li><br>
        <li><span class="fa fa-group"></span> <strong>GROUPS<?php foreach($grpnumbers as $grpnumber){?> ( <?php echo $grpnumber->no_groups." ";?> ) <?php }?></strong></li>
        <div style="height: 100px; overflow: auto;">
        <?php foreach($groups as $group){?>
          <li><a style="color: black" href="group/<?php echo $grp_id =  $group->group_id." " ;?>"><?php echo $group->group_name." ";?>  </a>
          </li>
        <?php }?>
      </div>
    <li><span class=""></span><strong>
    Events ( <?php foreach($eventnumbers as $numevents){?> <?php echo $numevents->numevents." ";?> <?php }?> ) </strong></li>
    <div style="height: 100px; overflow: auto;">
    <?php foreach($events as $event){?>
    <li><a href = "group/<?php echo $grp_id =  $event->group_id." " ;?>"><?php echo $event->event_name." ";?></a></li>
    <?php }?>
    </div>
...
<div class="col-7 status">
  ...
  <textarea placeholder="Well, say something!" id="status" cols="70" rows="3" name="text"></textarea>
  <div class="reply" style="padding-top: 10px;">
    <input type="submit" value="POST IT!" style="margin-right: 10px; float: right;">
...
<div class="col-7 status" >
<table>
<tr><td><a href ="profile/<?php echo $userid =  $user->idnumber." " ;?>">
<figure class="dp" 
