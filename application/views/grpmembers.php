...
<br>
 ...
 <div class="col-8 nav2">
  <ul>
    <li><a href="<?php echo base_url() ?>index.php/home/files/<?php echo $grp_id =  $name->group_id." " ;?>">Files</a></li>
...
<ol>
<?php foreach($grpmembers as $grpmember){?>
<h4>
<li><a href ="<?php echo base_url() ?>home/profile/<?php echo $userid =  $grpmember->idnumber." ";?>"><font color="black"> <?php echo $grpmember->fname;?> <?php echo $grpmember->mname;?> <?php echo $grpmember->lname;?></font></a></li>
</h4>
<?php }?>
</ol>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-group">
            <font color="black">
            <form action="<?php echo base_url();?>home/create_event/<?php echo $grp_id =  $name->group_id." " ;?>" method="POST">
