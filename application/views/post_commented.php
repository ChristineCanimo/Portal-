        ...
        <ul class="nav navbar-nav navbar-right">
          <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"><?php foreach($cntnotifs as $cntnotif){?>
            ...
            <ul class="dropdown-menu notify-drop">
              ...
              <li class="active"><a href="<?php echo base_url();?>home/home"><i class="fa fa-home"> HOME</a></i></li>
...
<?php foreach($statusnoti as $status){?>
...
<div class="container">
<i class="fa fa-comments-o" style="font-size:15px;color:red;cursor: pointer;"> Comments</i>
</div>
<div id="comment<?php echo $status->stat_id;?>" class="panel-collapse collapse in">
